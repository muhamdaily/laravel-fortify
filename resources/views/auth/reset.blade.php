                        ...
                        <div class="card card-success">
                            <div class="card-header justify-content-center">
                                <h4 class="text-success font-weight-normal">
                                    <span class="font-weight-bold">Atur Ulang Kata Sandi Anda
                                    </span>
                                </h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('password.update') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="password_confirmation" class="d-block"><span
                                                class="text-danger">*</span> Konfirmasi Kata Sandi</label>
